...
export const arabicMessages: TranslationMessages = {
  ra: {
    action: {
      ...
      clear_array_input: "افراغ مدخلات المصفوفة",
      create_item: "اضافة عنصر",
    ...
    message: {
      ...
      bulk_update_content:
        "هل أنت متأكد أنك تريد تحديث هذا %{name}؟ |||| هل أنت متأكد أنك تريد تحديث هذه العناصر %{smart_count}؟",
      bulk_update_title: "تحديث %{name} |||| تحديث %{smart_count} %{name}",
      clear_array_input: "هل أنت متأكد أنك تريد مسح القائمة بأكملها؟",
    },
    navigation: {
      ...
      first: "الذهاب إلى الصفحة الأولى",
      last: "الذهاب إلى الصفحة الأخيرة",
      page: "الذهاب إلى الصفحة %{page}",
      partial_page_range_info: "%{offsetBegin}-%{offsetEnd} من أكثر من %{offsetEnd}",
      previous: "الذهاب إلى الصفحة السابقة",
    },
    sort: {
    ...
    notification: {
      ...
      application_update_available: "هناك إصدار جديد متاح.",
      not_authorized: "ليس لديك الصلاحية للوصول إلى هذا المورد.",
    },
    validation: {
      required: "مطلوب",
    ...
    saved_queries: {
      ...
      remove_message: "هل أنت متأكد أنك تريد إزالة هذا العنصر من قائمة الاستعلامات المحفوظة؟",
      help: "تصفية القائمة وحفظ هذا الاستعلام لاستخدامه لاحقًا",
    },
    configurable: {
      customize: "تخصيص",
      ...
      inspector: {
        title: "المفتش",
        content: "تحوي المؤشرات على عناصر واجهة المستخدم لتكوينها",
